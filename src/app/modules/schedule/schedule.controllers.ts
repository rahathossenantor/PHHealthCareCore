...
const deleteSchedule = catchAsync(async (req: Request, res: Response, _next: NextFunction) => {
    const response = await scheduleServices.deleteScheduleFromDB(req.params.id);
